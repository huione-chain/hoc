...
module conventions::wallet {
    ...
    public fun destroy_empty(self: Wallet<Balance<HC>>) {
...
module conventions::access_control {
    ...
    public fun withdraw(state: &mut State, account: &mut Account, ctx: &mut TxContext): Coin<HC> {
    ...
    public fun wrong_withdraw(state: &mut State, ctx: &mut TxContext): Coin<HC> {
...
module conventions::vesting_wallet {
    ...
    */
    public fun new(deposit: Coin<HC>, ctx: &mut TxContext): OwnedWallet {
        // Implementation omitted.
        abort(0)
    }
    ...
    */
    public fun new_shared(deposit: Coin<HC>, ctx: &mut TxContext) {
        // Implementation omitted.
