...
```move title='house_data.move'
  public fun initialize_house_data(house_cap: HouseCap, coin: Coin<HC>, public_key: vector<u8>, ctx: &mut TxContext) {
...
```move title='single_player_satoshi.move'
  ...
  fun internal_start_game(guess: String, counter: &mut Counter, coin: Coin<HC>, house_data: &mut HouseData, fee_bp: u16, ctx: &mut TxContext): (ID, Game) {
...
│  │ Sender: 0x8e8cae7791a93778800b88b6a274de5c32a86484593568d38619c7ea71999654                            │
│  │ Owner: Account Address ( 0x8e8cae7791a93778800b88b6a274de5c32a86484593568d38619c7ea71999654 )         │
│  │ ObjectType: 0x2::coin::Coin<0x2::hc::HC>                                                            │
│  │ Version: 75261540                                                                                     │
...
// Player stake
const [stakeCoin] = txb.splitCoins(txb.gas, [MIST_PER_HC * BigInt(stake)]);
