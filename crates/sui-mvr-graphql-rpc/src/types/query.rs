...
impl Query {
    ...
    async fn available_range(&self, ctx: &Context<'_>) -> Result<AvailableRange> {
        ...
        AvailableRange::query(ctx.data_unchecked(), checkpoint).await.extend()
    }
    ...
    async fn owner(
        ...
        let Watermark { checkpoint, .. } = *ctx.data()?;
        Ok(Some(Owner { address, checkpoint_viewed_at: checkpoint, root_version: root_version.map(|v| v.into()) }))
    }
    ...
    async fn latest_package(&self, ctx: &Context<'_>, address: SuiAddress) -> Result<Option<MovePackage>> {
        let Watermark { checkpoint, .. } = *ctx.data()?;
        MovePackage::query(ctx, address, MovePackage::latest_at(checkpoint)).await.extend()
    }
    ...
    async fn address(&self, ctx: &Context<'_>, address: SuiAddress) -> Result<Option<Address>> {
        ...
        Ok(Some(Address { address, checkpoint_viewed_at: checkpoint }))
    }
    ...
    async fn epoch(&self, ctx: &Context<'_>, id: Option<UInt53>) -> Result<Option<Epoch>> {
        let Watermark { checkpoint, .. } = *ctx.data()?;
        Epoch::query(ctx, id.map(|id| id.into()), checkpoint).await.extend()
    }
    ...
    async fn checkpoint(&self, ctx: &Context<'_>, id: Option<CheckpointId>) -> Result<Option<Checkpoint>> {
        let Watermark { checkpoint, .. } = *ctx.data()?;
        Checkpoint::query(ctx, id.unwrap_or_default(), checkpoint).await.extend()
    }
    ...
    async fn coins(
        ...
        Coin::paginate(ctx.data_unchecked(), page, coin, /* owner */ None, checkpoint).await.extend()
    }
    ...
    async fn epochs(
        ...
        let page = Page::from_params(ctx.data_unchecked(), first, after, last, before)?;
        Epoch::paginate(ctx.data_unchecked(), page, checkpoint).await.extend()
    }
    ...
    async fn checkpoints(
        ...
        let page = Page::from_params(ctx.data_unchecked(), first, after, last, before)?;
        Checkpoint::paginate(ctx.data_unchecked(), page, /* epoch */ None, checkpoint).await.extend()
    }
    ...
    async fn transaction_blocks(
        ...
        TransactionBlock::paginate(ctx, page, filter.unwrap_or_default(), checkpoint, scan_limit).await.extend()
    }
    ...
    async fn events(
        ...
        let page = Page::from_params(ctx.data_unchecked(), first, after, last, before)?;
        Event::paginate(ctx.data_unchecked(), page, filter.unwrap_or_default(), checkpoint).await.extend()
    }
    ...
    async fn objects(
        ...
        let page = Page::from_params(ctx.data_unchecked(), first, after, last, before)?;
        Object::paginate(ctx.data_unchecked(), page, filter.unwrap_or_default(), checkpoint).await.extend()
    }
    ...
    async fn packages(
        ...
        let page = Page::from_params(ctx.data_unchecked(), first, after, last, before)?;
        MovePackage::paginate_by_checkpoint(ctx.data_unchecked(), page, filter, checkpoint).await.extend()
    }
    ...
    async fn package_versions(
        ...
        let page = Page::from_params(ctx.data_unchecked(), first, after, last, before)?;
        MovePackage::paginate_by_version(ctx.data_unchecked(), page, address, filter, checkpoint).await.extend()
    }
    ...
    async fn resolve_suins_address(&self, ctx: &Context<'_>, domain: Domain) -> Result<Option<Address>> {
        ...
        Ok(NameService::resolve_to_record(ctx, &domain, checkpoint)
            ...
            .map(|a| Address { address: a.into(), checkpoint_viewed_at: checkpoint }))
    }
    ...
    async fn package_by_name(&self, ctx: &Context<'_>, name: String) -> Result<Option<MovePackage>> {
        ...
        NamedMovePackage::query(ctx, &name, checkpoint).await.extend()
    }
    ...
    async fn coin_metadata(&self, ctx: &Context<'_>, coin_type: ExactTypeFilter) -> Result<Option<CoinMetadata>> {
        let Watermark { checkpoint, .. } = *ctx.data()?;
        CoinMetadata::query(ctx.data_unchecked(), coin_type.0, checkpoint).await.extend()
    }
