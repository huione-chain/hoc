...
module sui_system::rewards_distribution_tests {
    ...
    fun test_validator_rewards() {
        ...
        assert_validator_total_stake_amounts(
            validator_addrs(),
            vector[125 * MIST_PER_HC, 225 * MIST_PER_HC, 325 * MIST_PER_HC, 425 * MIST_PER_HC],
            scenario
        );
        ...
        assert_validator_total_stake_amounts(
            validator_addrs(),
            vector[150 * MIST_PER_HC, 970 * MIST_PER_HC, 350 * MIST_PER_HC, 450 * MIST_PER_HC],
            scenario
        );
        scenario_val.end();
    }
    ...
    fun test_stake_subsidy() {
        ...
        advance_epoch_with_reward_amounts(0, 100, scenario);
        assert_validator_total_stake_amounts(validator_addrs(), vector[100_000_025 * MIST_PER_HC, 200_000_025 * MIST_PER_HC, 300_000_025 * MIST_PER_HC, 400_000_025 * MIST_PER_HC], scenario);
        scenario_val.end();
    }
    ...
    fun test_stake_rewards() {
        ...
        assert_validator_total_stake_amounts(validator_addrs(), vector[300 * MIST_PER_HC, 300 * MIST_PER_HC, 300 * MIST_PER_HC, 400 * MIST_PER_HC], scenario);
        assert_validator_self_stake_amounts(validator_addrs(), vector[100 * MIST_PER_HC, 200 * MIST_PER_HC, 300 * MIST_PER_HC, 400 * MIST_PER_HC], scenario);

        // Each pool gets 30 SUI.
        advance_epoch_with_reward_amounts(0, 120, scenario);
        assert_validator_self_stake_amounts(validator_addrs(), vector[110 * MIST_PER_HC, 220 * MIST_PER_HC, 330 * MIST_PER_HC, 430 * MIST_PER_HC], scenario);
        ...
        assert_eq(total_sui_balance(STAKER_ADDR_1, scenario), 220 * MIST_PER_HC);
        assert_validator_self_stake_amounts(validator_addrs(), vector[140 * MIST_PER_HC, 240 * MIST_PER_HC, 360 * MIST_PER_HC, 460 * MIST_PER_HC], scenario);
        unstake(STAKER_ADDR_2, 0, scenario);
        assert_eq(total_sui_balance(STAKER_ADDR_2, scenario), 120 * MIST_PER_HC); // 20 SUI of rewards received

        advance_epoch_with_reward_amounts(0, 40, scenario);

        unstake(STAKER_ADDR_2, 0, scenario); // unstake 600 principal SUI
        // additional 600 SUI of principal and 46 SUI of rewards withdrawn to Coin<HC>
    ...
    fun test_validator_commission() {
        ...
        assert_validator_non_self_stake_amounts(validator_addrs(), vector[115 * MIST_PER_HC, 108 * MIST_PER_HC, 0, 0], scenario);
        assert_validator_self_stake_amounts(validator_addrs(), vector[115 * MIST_PER_HC, 222 * MIST_PER_HC, 330 * MIST_PER_HC, 430 * MIST_PER_HC], scenario);
        ...
        assert_validator_total_stake_amounts(validator_addrs(), vector[290 * MIST_PER_HC, 390 * MIST_PER_HC, 390 * MIST_PER_HC, 490 * MIST_PER_HC], scenario);
        ...
        assert_validator_non_self_stake_amounts(validator_addrs(), vector[142 * MIST_PER_HC, 123709090909, 0, 0], scenario);
        assert_validator_self_stake_amounts(validator_addrs(), vector[148 * MIST_PER_HC, 266290909091, 390 * MIST_PER_HC, 490 * MIST_PER_HC], scenario);
    ...
    fun test_rewards_slashing() {
        ...
        assert_validator_self_stake_amounts(validator_addrs(), vector[565 * MIST_PER_HC, 740 * MIST_PER_HC, 1230 * MIST_PER_HC, 1330 * MIST_PER_HC], scenario);
        ...
        assert!(total_sui_balance(STAKER_ADDR_1, scenario) == 565 * MIST_PER_HC);
        assert!(total_sui_balance(STAKER_ADDR_2, scenario) == 370 * MIST_PER_HC);
        scenario_val.end();
    }
    ...
    fun test_entire_rewards_slashing() {
        ...
        assert_validator_self_stake_amounts(validator_addrs(), vector[(550 + 150) * MIST_PER_HC, 200 * MIST_PER_HC, (1200 + 300) * MIST_PER_HC, (1300 + 300) * MIST_PER_HC], scenario);
        ...
        assert!(total_sui_balance(STAKER_ADDR_1, scenario) == (550 + 150) * MIST_PER_HC);
        assert!(total_sui_balance(STAKER_ADDR_2, scenario) == 100 * MIST_PER_HC);
        scenario_val.end();
    }
    ...
    fun test_rewards_slashing_with_storage_fund() {
        ...
        assert_validator_self_stake_amounts(validator_addrs(), vector[500 * MIST_PER_HC, 600 * MIST_PER_HC, 620 * MIST_PER_HC, 652 * MIST_PER_HC], scenario);
        ...
        assert_eq(total_sui_balance(STAKER_ADDR_1, scenario), (100 + 80) * MIST_PER_HC);
        // Staker 2 gets 300 * 1/5 * (1 - 20%) = 48 SUI of rewards.
        assert_eq(total_sui_balance(STAKER_ADDR_2, scenario), (100 + 48) * MIST_PER_HC);
    ...
    fun test_everyone_slashed() {
        ...
        assert_eq(system_state.get_storage_fund_total_balance(), 4000 * MIST_PER_HC);

        // The entire 1000 SUI of storage rewards should go to the object rebate portion of the storage fund.
        assert_eq(system_state.get_storage_fund_object_rebates(), 1000 * MIST_PER_HC);
    ...
    fun test_mul_rewards_withdraws_at_same_epoch() {
        ...
        assert_eq(system_state.validator_stake_amount(VALIDATOR_ADDR_1), 140 * 23 * MIST_PER_HC);
        test_scenario::return_shared(system_state);
        ...
        assert_eq(total_sui_balance(STAKER_ADDR_1, scenario), (220 + 130 + 20 * 3 + 10) * MIST_PER_HC);
        // staker 2's stake was active for 2 epochs so got 40 * 2 = 80 SUI of rewards
        assert_eq(total_sui_balance(STAKER_ADDR_2, scenario), (480 + 40 * 2) * MIST_PER_HC);
        // staker 3's first stake was active for 1 epoch and got 30 SUI of rewards
        // and her second stake didn't get any rewards.
        assert_eq(total_sui_balance(STAKER_ADDR_3, scenario), (390 + 280 + 30) * MIST_PER_HC);
        // staker 4 joined and left in an epoch where no rewards were earned so she got no rewards.
        assert_eq(total_sui_balance(STAKER_ADDR_4, scenario), 1400 * MIST_PER_HC);
        ...
        assert_eq(system_state.validator_stake_amount(VALIDATOR_ADDR_1), 140 * MIST_PER_HC);
        test_scenario::return_shared(system_state);
        scenario_val.end();
    }
    ...
    fun test_uncapped_rewards() {
        ...
        while (i < num_validators) {
            ...
            assert_eq(system_state.validator_stake_amount(addr), (962 + i * 4) * MIST_PER_HC);
            i = i + 1;
        };
        test_scenario::return_shared(system_state);
        scenario_val.end();
