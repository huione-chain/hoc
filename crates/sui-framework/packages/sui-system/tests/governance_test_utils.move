...
module sui_system::governance_test_utils {
    ...
    public fun advance_epoch_with_reward_amounts(
        ...
        let storage_rebate = advance_epoch_with_reward_amounts_return_rebate(storage_charge * MIST_PER_OCT, computation_charge * MIST_PER_OCT, 0, 0, scenario);
    ...
    public fun advance_epoch_with_reward_amounts_and_slashing_rates(
        ...
        let storage_rebate = system_state.advance_epoch_for_testing(
            new_epoch, 1, storage_charge * MIST_PER_OCT, computation_charge * MIST_PER_OCT, 0, 0, 0, reward_slashing_rate, 0, ctx
        );
        test_utils::destroy(storage_rebate);
        test_scenario::return_shared(system_state);
        scenario.next_epoch(@0x0);
    ...
    public fun stake_with(
        ...
        system_state.request_add_stake(coin::mint_for_testing(amount * MIST_PER_OCT, ctx), validator, ctx);
        test_scenario::return_shared(system_state);
    }
