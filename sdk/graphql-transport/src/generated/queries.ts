...
export type Balance = {
  ...
  /** Coin type for the balance, such as 0x2::hc::HC */
  coinType: MoveType;
...
export type IOwner = {
  address: Scalars['SuiAddress']['output'];
  /** Total balance of all coins with marker type owned by this object or address. If type is not supplied, it defaults to `0x2::hc::HC`. */
  balance?: Maybe<Balance>;
...
export type ObjectFilter = {
   ...
   * the full type name, such as `0x2::coin::Coin<0x2::hc::HC>`.
   */
  type?: InputMaybe<Scalars['String']['input']>;
};
...
export type Owner = IOwner & {
   ...
   * supplied, it defaults to `0x2::hc::HC`.
   */
  balance?: Maybe<Balance>;
  /** The balances of all coin types owned by this object or address. */
  balances: BalanceConnection;
...
export const GetCoinsDocument = new TypedDocumentString(`
    query getCoins($owner: SuiAddress!, $first: Int, $cursor: String, $type: String = "0x2::hc::HC") {
  address(address: $owner) {
    address
